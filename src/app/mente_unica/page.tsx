    ...
    <div className="min-h-screen">
      ...
      <section className="bg-[#B19B6D] flex flex-col justify-center items-center py-8 sm:py-12 md:py-16 px-4 sm:px-6">
        <div className="text-center space-y-3 sm:space-y-4">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl uppercase tracking-wider text-gray-100 leading-tight" style={{fontWeight: 300, fontFamily: 'Lato, sans-serif'}}>
            LA MENTE ÚNICA
          </h1>
        </div>
      </section>
      ...
      <section className="bg-white flex flex-col justify-center items-center py-8 sm:py-12 md:py-16 px-4 sm:px-6">
        <div className="text-center space-y-3 sm:space-y-4">
          ...
          <h3 className="text-[#B19B6D] text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl uppercase tracking-wide leading-tight">
            PARA DESPERTAR
          </h3>
        </div>
      </section>
