...
export default function AvisoLegalPage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-[#B19B6D] flex flex-col justify-center items-center h-[200px] md:h-[300px] px-4 sm:px-6">
        <div className="text-center space-y-3 sm:space-y-4">
          <h2 className="text-sm sm:text-base md:text-lg font-light uppercase tracking-wide text-gray-200">
            INFORMACIÓN
          </h2>
          <h1 className="text-[28px] md:text-[60px] uppercase tracking-wider text-gray-100 leading-tight font-light" style={{fontWeight: 300, fontFamily: 'Lato, sans-serif'}}>
            AVISO LEGAL
          </h1>
        </div>
      </section>
      ...
      {/* Content Section */}
      <section className="bg-white px-4 sm:px-6 md:px-8 lg:px-16 mt-[70px] mb-[240px] sm:mb-[225px] md:mb-[217px] lg:mb-[1175px] xl:mb-[1011px]">
        <div className="max-w-4xl mx-auto">
          <div className="space-y-6 text-gray-700 text-sm sm:text-base md:text-lg leading-relaxed">
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-gray-200">
              <h3 className="text-[16px] md:text-[20px] font-bold mb-6" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                AVISO LEGAL Y CONDICIONES GENERALES DE USO
              </h3>
              
              <div className="space-y-4 text-justify">
                <div className="bg-gray-50 p-4 rounded-lg mb-6">
                  <h4 className="text-[16px] md:text-[20px] font-bold mb-3" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>Índice de contenidos:</h4>
                  <ol className="list-decimal list-inside space-y-1 text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h4 className="text-[16px] md:text-[20px] font-bold mt-6" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>1. Datos identificativos</h4>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h4 className="text-[16px] md:text-[20px] font-bold mt-6" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>2. USUARIOS y responsabilidades</h4>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h4 className="text-[16px] md:text-[20px] font-bold mt-6" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>3. Uso del servicio</h4>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h5 className="text-[16px] md:text-[20px] font-bold mt-4" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>3.1 Condiciones Generales de Contratación</h5>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h5 className="text-[16px] md:text-[20px] font-bold mt-4" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>3.2 Cómo comprar y formas de pago</h5>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                  Para acceder a las funciones avanzadas, el USUARIO podrá realizar compras en la plataforma.
                </p>

                <h5 className="text-[16px] md:text-[20px] font-bold mt-4" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>3.3 Lista de precios</h5>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h6 className="text-[16px] md:text-[20px] font-bold mt-3" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>3.3.1 Precio de las verificaciones</h6>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                  Las verificaciones solicitadas por SENDACONSCIENTE serán gratuitas.
                </p>

                <h5 className="text-[16px] md:text-[20px] font-bold mt-4" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>3.4 Uso de la cuenta del USUARIO</h5>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h6 className="text-[16px] md:text-[20px] font-bold mt-3" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>3.4.1 Verificación de datos del USUARIO</h6>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h5 className="text-[16px] md:text-[20px] font-bold mt-4" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>3.5 Derecho de desistimiento</h5>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h4 className="text-[16px] md:text-[20px] font-bold mt-6" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>4. Privacidad y Protección de Datos</h4>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h4 className="text-[16px] md:text-[20px] font-bold mt-6" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>5. Propiedad intelectual e industrial</h4>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h5 className="text-[16px] md:text-[20px] font-bold mt-4" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>5.1 Elementos para publicidad y difusión</h5>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h4 className="text-[16px] md:text-[20px] font-bold mt-6" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>6. Exclusión de garantías y responsabilidad</h4>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h4 className="text-[16px] md:text-[20px] font-bold mt-6" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>7. Modificaciones</h4>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h4 className="text-[16px] md:text-[20px] font-bold mt-6" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>8. Enlaces</h4>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h5 className="text-[16px] md:text-[20px] font-bold mt-4" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>8.1 Enlaces entrantes</h5>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <ol className="list-decimal list-inside space-y-2 ml-4 text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h5 className="text-[16px] md:text-[20px] font-bold mt-4" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>8.2 Enlaces de referidos</h5>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h4 className="text-[16px] md:text-[20px] font-bold mt-6" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>9. Derecho de exclusión</h4>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h4 className="text-[16px] md:text-[20px] font-bold mt-6" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>10. Generalidades</h4>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h4 className="text-[16px] md:text-[20px] font-bold mt-6" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>11. Modificación de las presentes condiciones y duración</h4>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
                ...
                <h4 className="text-[16px] md:text-[20px] font-bold mt-6" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>12. Legislación aplicable y jurisdicción</h4>
                <p className="text-[16px] md:text-[20px] font-bold" style={{fontWeight: 400, fontFamily: 'Lato, sans-serif'}}>
